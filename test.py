...
faces = [Face(),Face()]
edges = [make_edge(vertices[0],vertices[1],left=faces[0]),make_edge(vertices[1],vertices[2],right=faces[0]),make_edge(vertices[0],vertices[2],left=faces[1],right=faces[1]),make_edge(vertices[2],vertices[3],left=faces[1]),make_edge(vertices[3],vertices[0],left=faces[1])]
...
vertices_to_add = [Vertex(275,150)]
